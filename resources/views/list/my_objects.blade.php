...
@section('title', "Список моїх об'єктів")
@section('content')
                        ...
                        <div class="col-md-12">
                            <div class="card card-danger">
                                <div class="card-header">
                                    <h3 class="card-title">Список моїх об'єктів</h3>
                                </div>
                                <div class="card-body p-0">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                        @if(\App\Models\Objects::where('user_id', Auth::user()->id)->count() == 0)
                                            <tr>
                                                <td class="align-middle text-center" colspan="5">Немає ніякої інформації</td>
                                            </tr>
                                        @else
                                            @foreach(\App\Models\Objects::where('user_id', Auth::user()->id)->get() as $object)
                                                <tr>
